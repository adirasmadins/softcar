...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rg_ie' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'cpf_cnpj' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        'street' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'city_id_clients' => ['type' => 'index', 'columns' => ['city_id'], 'length' => []],
            'state_id_clients' => ['type' => 'index', 'columns' => ['state_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'city_id_clients' => ['type' => 'foreign', 'columns' => ['city_id'], 'references' => ['cities', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'state_id_clients' => ['type' => 'foreign', 'columns' => ['state_id'], 'references' => ['states', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'rg_ie' => 'Lorem ipsum dolor sit amet',
            'cpf_cnpj' => 1,
            ...
            'cep' => 'Lorem ',
            'cnh' => 1,
            'validity_cnh' => '2016-08-25',
            'first_license' => '2016-08-25'
        ],
    ];
}
